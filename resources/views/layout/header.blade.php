...
<nav class="fixed w-full z-50 bg-dark-bg/80 backdrop-blur-xl border-b border-yolixa-purple/20 nav-glass">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <!-- Mobile Menu Button -->
            <div class="md:hidden">
                <button id="mobile-menu-btn" class="relative p-2 text-white hover:text-yolixa-purple transition-all duration-300 hover:bg-yolixa-purple/10 rounded-lg">
    ...
    <div id="mobile-menu" class="mobile-menu fixed top-0 right-0 h-full w-80 bg-dark-bg/95 backdrop-blur-xl border-l border-yolixa-purple/30 md:hidden mobile-glass">
        <div class="p-8">
            <div class="flex justify-between items-center mb-8">
                ...
                <button id="close-menu" class="p-2 text-white hover:text-yolixa-purple transition-all duration-300 hover:bg-yolixa-purple/10 rounded-lg">
