...
@section('content')
    ...
    <div id="walletModal" class="fixed inset-0 bg-black/60 hidden items-center justify-center z-50">
        <div class="bg-gray-900 rounded-2xl shadow-xl max-w-md w-full p-6 relative">
            ...
            <!-- Select Blockchain -->
            <div class="mb-4">
                <label for="blockchainSelect" class="block text-gray-300 mb-2">Select Blockchain</label>
            ...
            <!-- Select Wallet -->
            <div class="mb-6">
                <label for="walletSelect" class="block text-gray-300 mb-2">Select Wallet</label>
                <select id="walletSelect"
                    class="w-full px-4 py-3 rounded-lg bg-gray-800 text-white border border-gray-700 focus:border-yolixa-purple focus:ring focus:ring-yolixa-purple/30 outline-none">
                    <option value="">-- Choose Wallet --</option>
                    <option value="freighter">Freighter (Stellar)</option>
                </select>
            </div>
    ...
    <section class="py-20">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <button class="gradient-bg px-12 py-4 rounded-lg font-semibold text-xl hover:scale-105 transition-transform glow-effect">
                Create Your Account
            </button>
        </div>
    </section>
